...
public:
    ...
    inline void SetForward(const Vector& vecForward)
    {
        m_flMatVal[0][0] = vecForward.x;
        m_flMatVal[1][0] = vecForward.y;
        m_flMatVal[2][0] = vecForward.z;
    }

    inline void SetLeft(const Vector& vecLeft)
    {
        m_flMatVal[0][1] = vecLeft.x;
        m_flMatVal[1][1] = vecLeft.y;
        m_flMatVal[2][1] = vecLeft.z;
    }

    inline void SetUp(const Vector& vecUp)
    {
        m_flMatVal[0][2] = vecUp.x;
        m_flMatVal[1][2] = vecUp.y;
        m_flMatVal[2][2] = vecUp.z;
    }
    ...
    Vector origin() const { return Vector{ m_flMatVal[0][3], m_flMatVal[1][3], m_flMatVal[2][3] }; }
